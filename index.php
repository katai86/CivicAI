...
<script src="<?php echo htmlspecialchars(app_url('/assets/api_client.js'), ENT_QUOTES, 'UTF-8'); ?>?v=1"></script>
<script src="<?php echo htmlspecialchars(app_url('/assets/ui_toast.js'), ENT_QUOTES, 'UTF-8'); ?>?v=1"></script>
<script src="<?php echo htmlspecialchars(app_url('/assets/app.js'), ENT_QUOTES, 'UTF-8'); ?>?v=36"></script>
