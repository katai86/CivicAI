...
-- Csak akkor MODIFY, ha a role oszlop még nem tartalmazza a govuser értéket.
...
-- ========== 2026-11 authority_users már IF NOT EXISTS-szel van fent ==========
...
-- ========== 2026-25 EU Open Data – külső API cache és provider napló ==========
