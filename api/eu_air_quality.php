<?php
/**
 * EU / CAMS air quality proxy (WMS FeatureInfo).
 * GET, csak gov/admin. authority bbox középpontjára ad PM2.5/PM10/NO2/O3 értékeket.
 */
require_once __DIR__ . '/../db.php';
require_once __DIR__ . '/../util.php';
require_once __DIR__ . '/../services/CamsAirQualityService.php';
...
try {
    ...
    $sources = $data['ok'] ? ['cams_wms_public'] : [];
    ...
    if (function_exists('log_error')) {
        log_error('eu_air_quality: ' . $e->getMessage());
    }
