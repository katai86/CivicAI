...
- **Gov UI** – „EU / EEA & INSPIRE” kártya az Analytics oldalon, ha `eea_enabled` **vagy** `inspire_enabled`.
...
- **Eurostat figyelmeztetés** (Analytics): ha a részmodul be van kapcsolva, a szöveg **dinamikusan** jelenik meg, ha az **épp kiválasztott** hatóságnál nincs kitöltve az ország mező.
