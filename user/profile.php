  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    document.querySelectorAll('form[action*="friend_request"]').forEach(function(frm){
      frm.addEventListener('submit', function(e){
        ...
        .catch(function(err){ alert(<?= json_encode(t('common.error_generic') . ': ', JSON_UNESCAPED_UNICODE) ?> + (err.message || <?= json_encode(t('common.error_unknown'), JSON_UNESCAPED_UNICODE) ?>)); })
